...
let idade = 20
let isTerminouOEnsinoMédio = true
let isCursandoOutraFaculdade = true


if(idade){
    console.log("Tem 18 anos ou mais?", idade >= 18)
}


if(isTerminouOEnsinoMédio){
    console.log("Terminou o Ensino Médio?", isTerminouOEnsinoMédio == true)
}

if(isCursandoOutraFaculdade){
    console.log("Está cursando alguma faculdade?", isCursandoOutraFaculdade !== true)
}
